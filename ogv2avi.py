...
for file in files:
  ...
  salida=restaura(file1)+".avi"
  print'---------------------------------------------------------------------\n'
  print "Renombrando "+file+" a "+entrada+"\n"
  os.rename(file,entrada)
  print "Codificando "+entrada+" a salida.avi\n"
  if codifica(entrada)==0:
      print "Renombrando salida.avi a "+salida+"\n"
      os.rename("salida.avi",salida)
